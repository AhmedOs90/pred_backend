...
def lambda_handler(event, context):
    ...
    try:
        ...
        select_query = """
            ...
            FROM questions
            WHERE category = %s AND populated = 1
        ...
        # Retrieve the total count of users who are assigned to answer the questions
        # Retrieve user answers for the questions and calculate percentage
        questions_list = []
